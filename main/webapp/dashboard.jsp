    ...
    <section class="especificaciones" id="especificaciones">
        <div class="caja-contenedor">
            <div class="caja">
                ...
                <a href="bolsillo?accion=ConsultarSaldo" class="btn">Consultar</a>
            </div>
            <div class="caja">
                ...
                <a href="bolsillo?accion=RecargarCuenta" class="btn">Recargar</a>
            </div>
            <div class="caja">
                ...
                <a href="bolsillo?accion=RetirarDinero" class="btn">Retirar</a>
            </div>
        </div>
    </section>
    <div class="footer">
