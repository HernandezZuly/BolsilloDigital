...
<body>
    <header>
        <a class="logo">Recarga Saldo</a>
         <input type="checkbox" id="menu-bar">
        <label for="menu-bar" class="fa fa-bars"></label>
            <nav class="navbar">
                <a href="bolsillo?accion=Atras">Atrás</a>
            </nav>
    </header>
    <section class="formulario" id="formulario">
        <div class="image">
            <img src="img/iconoConsulta.png" alt="imagen">
        </div>
        <form action="bolsillo" method="post">
            <h1 class="heading">Saldo Actual</h1>
                <div class="inputcaja">
                    <p>Su recarga se realizó correctamente </p>
                    <p>Su saldo final fue de </p>
